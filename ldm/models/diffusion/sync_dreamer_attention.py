...
class DepthWiseAttention(UNetModel):
    def __init__(self, volume_dims=(5,16,32,64), zero_123_infer=False, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # num_heads = 4
        model_channels = kwargs['model_channels']
        channel_mult = kwargs['channel_mult']
        d0,d1,d2,d3 = volume_dims
        self.zero_123_infer = zero_123_infer
    ...
    def forward(self, x, timesteps=None, context=None, source_dict=None, **kwargs):
        ...
        if 'camera_embedding' in kwargs:
            emb = emb + kwargs['camera_embedding']
    ...
    def get_trainable_parameters(self):
        ...
        # if self.in_channels != 8:
            # new_paras=[]
            # for para in self.input_blocks[0].parameters():
            #     new_paras.append(para)
            # torch.save(new_paras[0],'/public/home/v-xuchf/Data/Teeth_recon/SyncDreamer/logs/mv256/mv-256/wgt2.pt')
            # torch.save(new_paras[1],'/public/home/v-xuchf/Data/Teeth_recon/SyncDreamer/logs/mv256/mv-256/bias2.pt')
            # wgt1=torch.load('/public/home/v-xuchf/Data/Teeth_recon/SyncDreamer/logs/mv256/mv-256/wgt1.pt')
            # wgt2=torch.load('/public/home/v-xuchf/Data/Teeth_recon/SyncDreamer/logs/mv256/mv-256/wgt2.pt')
            # b1=torch.load('/public/home/v-xuchf/Data/Teeth_recon/SyncDreamer/logs/mv256/mv-256/bias1.pt')
            # b2=torch.load('/public/home/v-xuchf/Data/Teeth_recon/SyncDreamer/logs/mv256/mv-256/bias2.pt')
            # print(((wgt1==wgt2)==False).sum())
            # print()
            # print(((b1==b2)==False).sum())
            # print()
            # paras += [para for para in self.input_blocks[0].parameters()]
        return paras
