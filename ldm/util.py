...
def prepare_inputs(image_paths, input_cam, target_cams, crop_size=-1, image_size=256):
    imgs = []
    ...
    inputs = {"input_image": torch.cat(imgs,-1)}
    inputs.update(input_cam)
    inputs.update(target_cams)
    return inputs